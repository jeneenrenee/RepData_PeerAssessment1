...
###There are `r sum(is.na(rawData$steps))` missing values in the data, all in the steps column.  I replaced them with the interval mean values calculated above (intervalAvg), which causes the median to shift a little but does not change the overall mean.
